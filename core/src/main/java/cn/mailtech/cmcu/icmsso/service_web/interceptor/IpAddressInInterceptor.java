package cn.mailtech.cmcu.icmsso.service_web.interceptor;

import cn.mailtech.cmcu.icmsso.util.CodesUtil;
...
public class IpAddressInInterceptor extends AbstractPhaseInterceptor<Message> {
    ...
    public void handleMessage(Message message) throws Fault {
        ...
        if (null != request) {
            ...
            logger.debug("ipAddress___________________"+ipAddress);
